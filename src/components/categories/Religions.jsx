...
const Religions = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    fetch('/data/Religions_data.json')
      .then(response => response.json())
      .then(data => setReligionsData(data))
  ...
  return (
    <div className="architecture-container">
      ...
      <div className="architecture-header">
        ...
        <h1 className="page-heading">Religions</h1>
  ...
  <div className="modal-blur-overlay" />
            ...
            <div className="modal-content">
              <h2>{selectedName}</h2>
              <p>
                {religionsData[selectedName] || "No details available for this person."}
              </p>
            </div>
          </div>
        </div>
